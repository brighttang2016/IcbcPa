...
public class Excelf30112_20151117bak extends BusParent implements FileUploadListener {
...
//		sqlStr = "delete t_ntmisc_bzcpmx t where user_id = ? and zq=? and t.used=? and t.seq_num=? ";
		sqlStr = "delete t_ntmisc_bzcpmx t where user_id = ? and zq=? and t.used=? ";
