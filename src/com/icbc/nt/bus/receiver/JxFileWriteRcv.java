...
public class JxFileWriteRcv extends BusParent implements BusReceiver {
	@Value("${jxExcelPath}")
...
//			fmtColCont.setVerticalAlignment(VerticalAlignment.CENTRE);
			...
			sheet.addCell(new Label(0, 1, "考核周期："+zq,zqWcf));
			...
			sheet.addCell(new Label(6, 2, "支行考核绩效",fmtColName));
			sheet.addCell(new Label(6, 3, "业务量",fmtColName));
			sheet.addCell(new Label(7, 3, "标准产品",fmtColName));
			sheet.addCell(new Label(8, 3, "特色业务",fmtColName));
			sheet.addCell(new Label(9, 3, "定性",fmtColName));
			
			sheet.mergeCells(10, 2, 13, 2);
			sheet.addCell(new Label(10, 2, "网点考核绩效",fmtColName));
			sheet.addCell(new Label(10, 3, "业务量",fmtColName));
			sheet.addCell(new Label(11, 3, "标准产品",fmtColName));
			sheet.addCell(new Label(12, 3, "特色业务",fmtColName));
			sheet.addCell(new Label(13, 3, "定性",fmtColName));
			
			sheet.mergeCells(14, 2, 17, 2);
			sheet.addCell(new Label(14, 2, "支行考核折算分",fmtColName));
			sheet.addCell(new Label(14, 3, "业务量",fmtColName));
			sheet.addCell(new Label(15, 3, "标准产品",fmtColName));
			sheet.addCell(new Label(16, 3, "特色业务",fmtColName));
			sheet.addCell(new Label(17, 3, "定性",fmtColName));
			
			
			sheet.mergeCells(18, 2, 21, 2);
			sheet.addCell(new Label(18, 2, "网点考核折算分",fmtColName));
			sheet.addCell(new Label(18, 3, "业务量",fmtColName));
			sheet.addCell(new Label(19, 3, "标准产品",fmtColName));
			sheet.addCell(new Label(20, 3, "特色业务",fmtColName));
			sheet.addCell(new Label(21, 3, "定性",fmtColName));
			
			sheet.mergeCells(22, 2, 22, 3);
			sheet.addCell(new Label(22, 2, "绩效合计",fmtColName));
			/***********************表头结束***********************/
			...
			for (int i = 0; i < ja.size(); i++) {
				...
				sheet.addCell(new Label(6, i+4, rowJson.getString("jx_ywl_zh"),fmtColCont));
				sheet.addCell(new Label(7, i+4, rowJson.getString("jx_bzcp_zh"),fmtColCont));
				sheet.addCell(new Label(8, i+4, rowJson.getString("jx_tscp_zh"),fmtColCont));
				sheet.addCell(new Label(9, i+4, rowJson.getString("jx_dx_zh"),fmtColCont));
				
				sheet.addCell(new Label(10, i+4, rowJson.getString("jx_ywl_wd"),fmtColCont));
				sheet.addCell(new Label(11, i+4, rowJson.getString("jx_bzcp_wd"),fmtColCont));
				sheet.addCell(new Label(12, i+4, rowJson.getString("jx_tscp_wd"),fmtColCont));
				sheet.addCell(new Label(13, i+4, rowJson.getString("jx_dx_wd"),fmtColCont));
				
				sheet.addCell(new Label(14, i+4, rowJson.getString("zsf_ywl_zh"),fmtColCont));
				sheet.addCell(new Label(15, i+4, rowJson.getString("zsf_bzcp_zh"),fmtColCont));
				sheet.addCell(new Label(16, i+4, rowJson.getString("zsf_tscp_zh"),fmtColCont));
				sheet.addCell(new Label(17, i+4, rowJson.getString("zsf_dx_zh"),fmtColCont));
				
				sheet.addCell(new Label(18, i+4, rowJson.getString("zsf_ywl_wd"),fmtColCont));
				sheet.addCell(new Label(19, i+4, rowJson.getString("zsf_bzcp_wd"),fmtColCont));
				sheet.addCell(new Label(20, i+4, rowJson.getString("zsf_tscp_wd"),fmtColCont));
				sheet.addCell(new Label(21, i+4, rowJson.getString("zsf_dx_wd"),fmtColCont));
				
				sheet.addCell(new Label(22, i+4, rowJson.getString("jx_hj"),fmtColCont));
			}
			int i = ja.size();
			sheet.addCell(new Label(0, i+6, "总计:",fmtColCont));
			sheet.addCell(new Label(6, i+6, hzJson.getString("hz_jx_ywl_zh"),fmtColCont));
			sheet.addCell(new Label(7, i+6, hzJson.getString("hz_jx_bzcp_zh"),fmtColCont));
			sheet.addCell(new Label(8, i+6, hzJson.getString("hz_jx_tscp_zh"),fmtColCont));
			sheet.addCell(new Label(9, i+6, hzJson.getString("hz_jx_dx_zh"),fmtColCont));
			
			sheet.addCell(new Label(10, i+6, hzJson.getString("hz_jx_ywl_wd"),fmtColCont));
			sheet.addCell(new Label(11, i+6, hzJson.getString("hz_jx_bzcp_wd"),fmtColCont));
			sheet.addCell(new Label(12, i+6, hzJson.getString("hz_jx_tscp_wd"),fmtColCont));
			sheet.addCell(new Label(13, i+6, hzJson.getString("hz_jx_dx_wd"),fmtColCont));
			
			sheet.addCell(new Label(14, i+6, hzJson.getString("hz_jx_hj"),fmtColCont));
			...
			logger.info("文件生成失败，事物已回滚，path:"+path);
			e.printStackTrace();
		}
	}
...
//		System.out.println("********dataPrepare*********");
		...
		String zq = tmd.get("zqCurr").toString();
		String fileName = "当期绩效-"+tmd.get("userId")+zq+".xls";
		...
		tmd.put("errorMsg","当期绩效文件写入完成");
		tmd.put("progress", "1");
		tmd.put("finish", "1");
//		tmd.put("data", tmd.get("zqCurr").toString());
	}
	
	public void jxFileWrite(JSONArray ja,
			LinkedHashMap<String, Object> condition, Map retMap,
			TransactionMapData tmd){
		logger.info("*****jxFileDown*****");
		System.out.println("*****jxFileDown*****");
	...
	public void doWork(JSONArray ja, LinkedHashMap<String, Object> condition,
		...
		this.jxFileWrite(ja, condition, retMap, tmd);
	}
