...
public class F10000080Rcv extends BusParent implements BusReceiver {
	@Autowired
...
//		LinkedList<String> table = new LinkedList<String>();//文件数据源
		...
		logger.info("执行sql，历史绩效查询,sqlStr:"+sqlStr+"-----condition:"+condition);
