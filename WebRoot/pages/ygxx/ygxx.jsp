...
<html>
  ...
  <base href="<%=basePath%>">
	...
	<!-- <script type="text/javascript" src="pages/ygxx/ygxx_store.js"></script>
	<script type="text/javascript" src="pages/ygxx/ygxx_mod.js"></script>
	-->
	<script type="text/javascript" src="pages/ygxx/ygxx_store.js"></script>
	...
	<script type="text/javascript" src="pages/ygxx/ygxx_fun.js"></script>
	<script type="text/javascript" src="pages/ygxx/ygxx.js"></script> 
  </head>
<body>
	 <!-- 
