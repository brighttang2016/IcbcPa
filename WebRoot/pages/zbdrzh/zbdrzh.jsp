...
<html>
  ...
  <base href="<%=basePath%>">
	...
	<script type="text/javascript" src="pages/zbdrzh/zbdrzh_store.js"></script>
	<script type="text/javascript" src="js/public/grxx_store.js"></script>
	<script type="text/javascript" src="pages/zbdrzh/zbdrzh_mod.js"></script>
	...
	<script type="text/javascript" src="pages/zbdrzh/zbdrzh_fun.js"></script>
	<script type="text/javascript" src="pages/zbdrzh/zbdrzh.js"></script>
	<script>
	var userId = "<%=userId%>";
	</script>
  </head>
