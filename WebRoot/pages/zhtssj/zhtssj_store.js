...
Ext.regModel('tableModel',{
	fields:['orgid','orgname',
	        ...
	        ,'username','zq','col1','col2','col3','col4','col5','col6','col7','col8','col9','col10','col11'
	        ,'col12','col13','col14','col15','col16','col17','col18','col18']
});
...
//	autoLoad:false,
	...
	proxy:{
		type:'ajax',
		url:'initDataControler.html?tx_code=30121',
        /*params:{
        	tx_code:'30069'
        },*/
