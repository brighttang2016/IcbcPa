...
<html>
  ...
  <base href="<%=basePath%>">
	...
	<script type="text/javascript" src="pages/zhtssj/zhtssj_store.js"></script>
	<script type="text/javascript" src="pages/zhtssj/zhtssj_mod.js"></script>
	...
	<script type="text/javascript" src="pages/zhtssj/zhtssj.js"></script>
	<script type="text/javascript" src="pages/zhtssj/zhtssj_fun.js"></script>
	<script>
	var userId = "<%=userId%>";
	</script>
  </head>
