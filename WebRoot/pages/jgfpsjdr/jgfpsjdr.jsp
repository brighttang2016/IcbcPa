...
<html>
  ...
  <base href="<%=basePath%>">
	...
	<script type="text/javascript" src="pages/jgfpsjdr/jgfpsjdr_store.js"></script>
	<script type="text/javascript" src="pages/jgfpsjdr/jgfpsjdr_mod.js"></script>
	...
	<script type="text/javascript" src="pages/jgfpsjdr/jgfpsjdr.js"></script>
	<script type="text/javascript" src="pages/jgfpsjdr/jgfpsjdr_fun.js"></script>
	<script>
	var userId = "<%=userId%>";
	</script>
  </head>
