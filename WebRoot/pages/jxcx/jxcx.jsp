...
<html>
  ...
  <base href="<%=basePath%>">
	...
	<script type="text/javascript" src="pages/jxcx/jxcx_store.js"></script>
	<script type="text/javascript" src="js/public/grxx_store.js"></script>
	<script type="text/javascript" src="pages/jxcx/jxcx_mod.js"></script>
	...
	<script type="text/javascript" src="pages/jxcx/jxcx_fun.js"></script>
	<script type="text/javascript" src="pages/jxcx/jxcx.js"></script>
