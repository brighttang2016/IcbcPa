...
<html>
  ...
  <base href="<%=basePath%>">
	...
	<script type="text/javascript" src="pages/ywlsjls/ywlsjls_store.js"></script>
	<script type="text/javascript" src="pages/ywlsjls/ywlsjls_mod.js"></script>
	...
	<script type="text/javascript" src="pages/ywlsjls/ywlsjls.js"></script>
	<script type="text/javascript" src="pages/ywlsjls/ywlsjls_fun.js"></script>
	<script>
	var userId = "<%=userId%>";
	</script>
  </head>
