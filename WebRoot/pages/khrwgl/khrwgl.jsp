...
<html>
  ...
  <base href="<%=basePath%>">
    ...
    body{background-color:#DFE9F6}   
     .borderClass{border:0px solid red}     
	</style> 
	...
	<script type="text/javascript" src="js/common_fun.js"></script>
	 ...
	 <script type="text/javascript" src="pages/khrwgl/khrwgl_mod.js"></script>
	 <script type="text/javascript" src="pages/khrwgl/khrwgl_store.js"></script>
	 <script type="text/javascript" src="pages/khrwgl/khrwgl_fun.js"></script>
	 <script type="text/javascript" src="pages/khrwgl/khrwgl.js"></script> 
