...
<%--     <script type='text/javascript' src='<%=basePath%>js/lib/dwr/engine.js'></script>
    ...
    <script type="text/javascript" src="<%=basePath%>js/libdwr/util.js"></script>
    <script type="text/javascript" src="<%=basePath%>js/lib/dwr/interface/MessagePush.js"></script>
	...
	<script type="text/javascript" src="pages/bzcpsj/bzcpsj_store.js"></script>
	<script type="text/javascript" src="pages/bzcpsj/bzcpsj_mod.js"></script>
	...
	<script type="text/javascript" src="pages/bzcpsj/bzcpsj.js"></script>
	<script type="text/javascript" src="pages/bzcpsj/bzcpsj_fun.js"></script>
	<script>
	var userId = "<%=userId%>";
