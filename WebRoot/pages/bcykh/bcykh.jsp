...
<html>
  ...
  <base href="<%=basePath%>">
	...
	<script type="text/javascript" src="pages/bcykh/bcykh_store.js"></script>
	<!-- <script type="text/javascript" src="pages/bcykh/org_mod.js"></script> -->
 	<script type="text/javascript" src="js/component/org.js"></script>
 	<script type="text/javascript" src="pages/bcykh/bcykh_mod.js"></script>
	<script type="text/javascript" src="pages/bcykh/bcykh.js"></script>
	<script type="text/javascript" src="pages/bcykh/bcykh_fun.js"></script>
	<script>
	var userId = "<%=userId%>";
	</script>
  </head>
