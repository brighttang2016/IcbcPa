...
<html>
  ...
  <base href="<%=basePath%>">
	...
	<script type="text/javascript" src="pages/zhtssjls/zhtssjls_store.js"></script>
	<script type="text/javascript" src="pages/zhtssjls/zhtssjls_mod.js"></script>
	...
	<script type="text/javascript" src="pages/zhtssjls/zhtssjls.js"></script>
	<script type="text/javascript" src="pages/zhtssjls/zhtssjls_fun.js"></script>
	<script>
	var userId = "<%=userId%>";
	</script>
  </head>
