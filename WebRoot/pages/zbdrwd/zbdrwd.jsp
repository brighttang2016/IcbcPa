...
<html>
  ...
  <base href="<%=basePath%>">
	...
	<script type="text/javascript" src="pages/zbdrwd/zbdrwd_store.js"></script>
	<script type="text/javascript" src="js/public/grxx_store.js"></script>
	<script type="text/javascript" src="pages/zbdrwd/zbdrwd_mod.js"></script>
	...
	<script type="text/javascript" src="pages/zbdrwd/zbdrwd_fun.js"></script>
	<script type="text/javascript" src="pages/zbdrwd/zbdrwd.js"></script>
	<script>
	var userId = "<%=userId%>";
	</script>
  </head>
