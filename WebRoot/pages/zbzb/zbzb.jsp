...
<html>
  ...
  <base href="<%=basePath%>">
	...
	<script type="text/javascript" src="js/common_fun.js"></script>
	 ...
	 <script type="text/javascript" src="pages/zbzb/zbzb_mod.js"></script>
	 <script type="text/javascript" src="pages/zbzb/zbzb_store.js"></script>
	 <script type="text/javascript" src="pages/zbzb/zbzb_fun.js"></script>
	 <script type="text/javascript" src="pages/zbzb/zbzb.js"></script> 
