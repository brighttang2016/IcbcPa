...
<html>
  ...
  <base href="<%=basePath%>">
	...
	<script type="text/javascript" src="pages/gryjdr/gryjdr_store.js"></script>
	<script type="text/javascript" src="js/public/grxx_store.js"></script>
	<script type="text/javascript" src="pages/gryjdr/gryjdr_mod.js"></script>
	...
	<script type="text/javascript" src="pages/gryjdr/gryjdr_fun.js"></script>
	<script type="text/javascript" src="pages/gryjdr/gryjdr.js"></script>
	<script>
	var userId = "<%=userId%>";
	</script>
  </head>
