...
<html>
  ...
  <base href="<%=basePath%>">
	...
	<script type="text/javascript" src="pages/dxsj/dxsj_store.js"></script>
	<script type="text/javascript" src="pages/dxsj/dxsj_mod.js"></script>
	...
	<script type="text/javascript" src="pages/dxsj/dxsj.js"></script>
	<script type="text/javascript" src="pages/dxsj/dxsj_fun.js"></script>
	<script>
	var userId = "<%=userId%>";
	</script>
  </head>
