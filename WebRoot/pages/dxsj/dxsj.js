...
//				stripeRows:true
			...
			tbar:[{
				text:'上传支行定性考核基础数据批量文件',
				iconCls:'Folderup',
				handler:function(){
					fileUpload("30132","上传支行定性考核基础数据批量文件");
				}
			},{
				text:'下载批量模版文件',
				iconCls:'Packagedown',
...
//					document.location = "downLoad.html?txCode=30062";//会导致【MessagePush.onPageLoad(userId);】已注册的后台监听失效
					Ext.getDom('downloadIframe').src = "downLoad.html?tx_code=30132";
				}
			}],
