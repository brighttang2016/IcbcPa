...
//		    Ext.create('Ext.grid.RowNumberer',{text:'行号',width:40,align:'center'}),//行号
			{header:'机构编码',dataIndex:'orgId',width:150,sortable:false,align:'center'},
			{header:'机构名称',dataIndex:'orgName',width:130,sortable:false,align:'center'},
			{header:'MOVA机构得分',dataIndex:'ptMova',width:150,sortable:true,align:'center'},
...
//				stripeRows:true
			...
			tbar:[{
				...
				iconCls:'Folderup',
				handler:function(){
					fileUpload("10000055","上传MOVA机构得分批量文件");
				}
			},{
				text:'下载批量模版文件',
				iconCls:'Packagedown',
...
//					document.location = "downLoad.html?txCode=30062";//会导致【MessagePush.onPageLoad(userId);】已注册的后台监听失效
					Ext.getDom('downloadIframe').src = "downLoad.html?tx_code=10000055";
				}
			}],
