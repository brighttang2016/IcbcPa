...
<html>
  ...
  <base href="<%=basePath%>">
	...
	<script type="text/javascript" src="pages/movajgdfdr/movajgdfdr_store.js"></script>
	<script type="text/javascript" src="pages/movajgdfdr/movajgdfdr_mod.js"></script>
	...
	<script type="text/javascript" src="pages/movajgdfdr/movajgdfdr.js"></script>
	<script type="text/javascript" src="pages/movajgdfdr/movajgdfdr_fun.js"></script>
	<script>
	var userId = "<%=userId%>";
	</script>
  </head>
