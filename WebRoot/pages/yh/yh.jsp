...
<html>
  ...
  <base href="<%=basePath%>">
	...
	<script type="text/javascript" src="pages/yh/yh_store.js"></script>
	<script type="text/javascript" src="pages/yh/yh_mod.js"></script>
 	<script type="text/javascript" src="js/component/org.js"></script>
 	<script type="text/javascript" src="js/component/jbjx.js"></script>
	...
	<script type="text/javascript" src="pages/yh/yh.js"></script>
	<script type="text/javascript" src="pages/yh/yh_fun.js"></script>
  </head>
<body>
	 <!-- 
