...
//					checkForm.getForm().reset();
		...
		var myColumns = [ 
			...
			{ text: '单位',  dataIndex: 'unit',width:130,sortable:true,align:'center'},
			{ text: '机构设定分值',  dataIndex: 'org_point',width:130,sortable:true,align:'center'},
			{ text: 'mova标准分值',  dataIndex: 'point',width:130,sortable:true,align:'center'}/*,
			{header:'删除',width:80,align:'center',
				...
				items:[{
					...
					handler:function(var1,var2,var3){//var1:当前Ext.grid.Panel对象，var2:当前操作行，var3:当前操作列
						...
						handleDel(rec,"uctManage.html","gridStoreId");
					}
				}]
			}*/
		];
...
//						icon:'images/ext/add.gif',
				...
				iconCls:'Delete',
				handler:function(){
					new comm().handleDelBat(myGrid,"zbfwControler.html","30143","gridStoreId");
				}
			},{
				text:'编辑',
				cls:'x-btn-text-icon',
