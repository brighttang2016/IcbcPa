...
<html>
  ...
  <base href="<%=basePath%>">
	...
	<script type="text/javascript" src="pages/bzzbfw/bzzbfw_store.js"></script>
 	<script type="text/javascript" src="js/component/org.js"></script>
 	<script type="text/javascript" src="pages/bzzbfw/bzzbfw_mod.js"></script>
	<script type="text/javascript" src="pages/bzzbfw/bzzbfw.js"></script>
	<script type="text/javascript" src="pages/bzzbfw/bzzbfw_fun.js"></script>
	<script>
	var userId = "<%=userId%>";
	</script>
  </head>
