...
<html>
  ...
  <base href="<%=basePath%>">
	...
	<script type="text/javascript" src="pages/xxjf/xxjf_store.js"></script>
	<script type="text/javascript" src="pages/xxjf/xxjf_mod.js"></script>
	...
	<script type="text/javascript" src="pages/xxjf/xxjf.js"></script>
	<script type="text/javascript" src="pages/xxjf/xxjf_fun.js"></script>
	<script>
	var userId = "<%=userId%>";
	</script>
  </head>
