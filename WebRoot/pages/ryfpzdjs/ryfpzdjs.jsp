...
<html>
  ...
  <base href="<%=basePath%>">
	...
	<script type="text/javascript" src="pages/ryfpzdjs/ryfpzdjs_store.js"></script>
	<script type="text/javascript" src="js/public/grxx_store.js"></script>
	<script type="text/javascript" src="pages/ryfpzdjs/ryfpzdjs_mod.js"></script>
	...
	<script type="text/javascript" src="pages/ryfpzdjs/ryfpzdjs_fun.js"></script>
	<script type="text/javascript" src="pages/ryfpzdjs/ryfpzdjs.js"></script>
