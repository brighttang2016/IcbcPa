...
<html>
  ...
  <base href="<%=basePath%>">
	...
	<script type="text/javascript" src="pages/ryfpsjdr/ryfpsjdr_store.js"></script>
	<script type="text/javascript" src="js/public/grxx_store.js"></script>
	<script type="text/javascript" src="pages/ryfpsjdr/ryfpsjdr_mod.js"></script>
	...
	<script type="text/javascript" src="pages/ryfpsjdr/ryfpsjdr_fun.js"></script>
	<script type="text/javascript" src="pages/ryfpsjdr/ryfpsjdr.js"></script>
	<script>
	var userId = "<%=userId%>";
	</script>
  </head>
