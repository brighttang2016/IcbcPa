...
<html>
  ...
  <base href="<%=basePath%>">
	...
	<script type="text/javascript" src="pages/jgfpjgcx/jgfpjgcx_store.js"></script>
	<script type="text/javascript" src="pages/jgfpjgcx/jgfpjgcx_mod.js"></script>
	...
	<script type="text/javascript" src="pages/jgfpjgcx/jgfpjgcx.js"></script>
	<script type="text/javascript" src="pages/jgfpjgcx/jgfpjgcx_fun.js"></script>
	<script>
	var userId = "<%=userId%>";
	</script>
  </head>
