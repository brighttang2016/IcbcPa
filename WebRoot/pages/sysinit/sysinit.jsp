...
<html>
  ...
  <base href="<%=basePath%>">
	...
	<script type="text/javascript" src="pages/sysinit/sysinit_store.js"></script>
	<script type="text/javascript" src="js/public/grxx_store.js"></script>
	<script type="text/javascript" src="pages/sysinit/sysinit_mod.js"></script>
	...
	<script type="text/javascript" src="pages/sysinit/sysinit_fun.js"></script>
	<script type="text/javascript" src="pages/sysinit/sysinit.js"></script>
