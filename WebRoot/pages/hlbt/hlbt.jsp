...
<html>
  ...
  <base href="<%=basePath%>">
	...
	<script type="text/javascript" src="pages/hlbt/hlbt_store.js"></script>
	 <script type="text/javascript" src="pages/hlbt/hlbt_mod.js"></script>
	<script type="text/javascript" src="pages/hlbt/hlbt.js"></script>
	<script type="text/javascript" src="pages/hlbt/hlbt_fun.js"></script>
  </head>
<body>
</body>
</html>
