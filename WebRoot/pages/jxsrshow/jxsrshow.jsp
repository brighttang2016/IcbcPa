...
<html>
  ...
  <base href="<%=basePath%>">
	...
	<script type="text/javascript" src="pages/jxsrshow/jxsrshow_store.js"></script>
	<script type="text/javascript" src="pages/jxsrshow/jxsrshow_mod.js"></script>
	...
	<script type="text/javascript" src="pages/jxsrshow/jxsrshow.js"></script>
	<script type="text/javascript" src="pages/jxsrshow/jxsrshow_fun.js"></script>
	<script>
	var userId = "<%=userId%>";
	</script>
  </head>
