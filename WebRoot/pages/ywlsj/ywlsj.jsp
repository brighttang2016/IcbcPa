...
<html>
  ...
  <base href="<%=basePath%>">
	...
	<script type="text/javascript" src="pages/ywlsj/ywlsj_store.js"></script>
	<script type="text/javascript" src="pages/ywlsj/ywlsj_mod.js"></script>
	...
	<script type="text/javascript" src="pages/ywlsj/ywlsj.js"></script>
	<script type="text/javascript" src="pages/ywlsj/ywlsj_fun.js"></script>
	<script>
	var userId = "<%=userId%>";
	</script>
  </head>
