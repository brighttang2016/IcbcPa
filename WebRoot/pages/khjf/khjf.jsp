...
<html>
  ...
  <base href="<%=basePath%>">
	...
	<script type="text/javascript" src="pages/khjf/khjf_store.js"></script>
	 <script type="text/javascript" src="pages/khjf/khjf_mod.js"></script>
	<script type="text/javascript" src="pages/khjf/khjf.js"></script>
	<script type="text/javascript" src="pages/khjf/khjf_fun.js"></script>
  </head>
<body>
</body>
</html>
