...
<html>
  ...
  <base href="<%=basePath%>">
	...
	<script type="text/javascript" src="pages/khjl/khjl_store.js"></script>
	<script type="text/javascript" src="pages/khjl/khjl_mod.js"></script>
	<script type="text/javascript" src="pages/khjl/khjl.js"></script>
	<script type="text/javascript" src="pages/khjl/khjl_fun.js"></script>
		<script>
	var userId = "<%=userId%>";
	</script>
  </head>
