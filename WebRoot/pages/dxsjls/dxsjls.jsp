...
<html>
  ...
  <base href="<%=basePath%>">
	...
	<script type="text/javascript" src="pages/dxsjls/dxsjls_store.js"></script>
	<script type="text/javascript" src="pages/dxsjls/dxsjls_mod.js"></script>
	...
	<script type="text/javascript" src="pages/dxsjls/dxsjls.js"></script>
	<script type="text/javascript" src="pages/dxsjls/dxsjls_fun.js"></script>
	<script>
	var userId = "<%=userId%>";
	</script>
  </head>
