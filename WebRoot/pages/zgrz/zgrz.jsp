...
<html>
  ...
  <base href="<%=basePath%>">
	...
	<script type="text/javascript" src="pages/zgrz/zgrz_store.js"></script>
 	<script type="text/javascript" src="js/component/org.js"></script>
 	<script type="text/javascript" src="pages/zgrz/zgrz_mod.js"></script>
	<script type="text/javascript" src="pages/zgrz/zgrz.js"></script>
	<script type="text/javascript" src="pages/zgrz/zgrz_fun.js"></script>
	<script>
	var userId = "<%=userId%>";
	</script>
  </head>
