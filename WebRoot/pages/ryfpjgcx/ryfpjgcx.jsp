...
<html>
  ...
  <base href="<%=basePath%>">
	...
	<script type="text/javascript" src="pages/ryfpjgcx/ryfpjgcx_store.js"></script>
	<script type="text/javascript" src="js/public/grxx_store.js"></script>
	<script type="text/javascript" src="pages/ryfpjgcx/ryfpjgcx_mod.js"></script>
	...
	<script type="text/javascript" src="pages/ryfpjgcx/ryfpjgcx_fun.js"></script>
	<script type="text/javascript" src="pages/ryfpjgcx/ryfpjgcx.js"></script>
